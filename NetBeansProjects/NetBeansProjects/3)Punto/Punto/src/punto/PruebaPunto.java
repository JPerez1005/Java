...
public class PruebaPunto {
    public static void main (String[] args){
        ...
        x= Integer.parseInt(JOptionPane.showInputDialog(" Ingrese el valor de la coordenada x del punto: "));
        y= Integer.parseInt(JOptionPane.showInputDialog(" Ingrese el valor de la coordenada y del punto: "));
