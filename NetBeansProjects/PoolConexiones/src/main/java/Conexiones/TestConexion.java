...
public class TestConexion extends javax.swing.JFrame {
    ...
    Conexión instanciaConexión = Conexión.getInstance();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            conexion = instanciaConexión.conectar();
            consulta = conexion.prepareStatement("select * from cliente");
            
            resultado = consulta.executeQuery();
            
            if(resultado.next()){
                JOptionPane.showMessageDialog(null, "Existen datos");
            }else{
            ...
            instanciaConexión.cerrarStatement(consulta);
            instanciaConexión.cerrarResultSet(resultado);
            instanciaConexión.desconectar(conexion);
        }
